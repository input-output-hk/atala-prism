package io.iohk.atala.prism.app.crypto;

import static io.iohk.atala.prism.app.core.exception.ErrorCode.CRYPTO_UNKNOWN_PRIVATE_KEY_TYPE;
import static io.iohk.atala.prism.app.core.exception.ErrorCode.CRYPTO_UNKNOWN_PUBLIC_KEY_TYPE;

import com.google.common.collect.ImmutableList;
import com.google.firebase.crashlytics.FirebaseCrashlytics;

import io.iohk.atala.prism.app.core.exception.CryptoException;
...
public class ECKeys {
    ...
    static {
        ...
        } catch (NoSuchAlgorithmException | NullPointerException | SecurityException e) {
