...
class NotificationsAdapter(private val onSelectItem: OnSelectItem<ActivityHistoryWithCredential>?) : BaseRecyclerViewAdapter<ActivityHistoryWithCredential>() {
    ...
    private class ViewHolder(private val binding: RowNotificationBinding, private val onSelectItem: OnSelectItem<ActivityHistoryWithCredential>?) : BaseRecyclerViewAdapter.ViewHolder<ActivityHistoryWithCredential>(binding.root) {
        ...
        override fun bind(data: ActivityHistoryWithCredential) {
            ...
            data.credential?.let {
                ...
                binding.issuedDateTextView.text = ctx.getString(R.string.received, dateFormatDDMMYYYY.format(it.dateReceived))
