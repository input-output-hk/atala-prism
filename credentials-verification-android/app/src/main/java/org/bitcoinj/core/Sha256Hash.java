...
import io.iohk.cvp.crypto.Utils;
import java.io.File;
...
public class Sha256Hash implements Serializable, Comparable<Sha256Hash> {
  ...
  /**
   * Calculates the hash of hash on the given chunks of bytes. This is equivalent to concatenating
   * the two chunks and then passing the result to {@link #hashTwice(byte[])}.
   */
