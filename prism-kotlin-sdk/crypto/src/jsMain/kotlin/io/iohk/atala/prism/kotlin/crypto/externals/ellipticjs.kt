...
import io.iohk.atala.prism.kotlin.crypto.externals.base.BasePoint
import io.iohk.atala.prism.kotlin.crypto.externals.PresetCurve
import io.iohk.atala.prism.kotlin.crypto.externals.edwards
import io.iohk.atala.prism.kotlin.crypto.externals.eddsa.Signature as _eddsa_Signature
import io.iohk.atala.prism.kotlin.crypto.externals.eddsa.KeyPair as _eddsa_KeyPair
import io.iohk.atala.prism.kotlin.crypto.externals.eddsa.KeyPairOptions as _eddsa_KeyPairOptions
...
external open class eddsa(name: String /* "ed25519" */) {
    ...
    open fun keyFromPublic(pub: BasePoint): _eddsa_KeyPair
