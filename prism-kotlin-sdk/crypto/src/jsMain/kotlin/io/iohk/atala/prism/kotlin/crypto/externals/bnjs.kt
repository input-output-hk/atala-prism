...
external open class BN {
    ...
    open fun toArray(endian: String /* "le" | "be" */ = definedExternally, length: Number = definedExternally): Array<Number>
    open fun toArrayLike(ArrayType: Array<Any>, endian: String /* "le" | "be" */ = definedExternally, length: Number = definedExternally): Array<Any>
