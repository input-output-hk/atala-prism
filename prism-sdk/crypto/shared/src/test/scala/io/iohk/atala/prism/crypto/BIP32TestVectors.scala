...
object BIP32TestVectors {
  case class Derivation(path: String, pubKeyHex: String, privKeyHex: String)
  case class TestVector(seedHex: String, derivations: List[Derivation])

  // generated using:
  // sbt "cryptoJVM/test:runMain io.iohk.atala.prism.crypto.BIP32TestVectorTransformer" | sed 's/\[info\] //g'
  // derivations structure [path, compressed public key, private key]
  val source =
    """
      |[
      |  {
      ...
      |        "ddb80b067e0d4993197fe10f2657a844a384589847602d56f0c629c81aae32"
      |      ],
      |      [
      |        "m/0'",
