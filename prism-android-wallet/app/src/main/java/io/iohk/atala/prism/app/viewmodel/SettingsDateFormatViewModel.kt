...
class SettingsDateFormatViewModel(private val dataManager: DataManager) : ViewModel() {
...
/**
 * Factory for [SettingsDateFormatViewModel].
 * */
class SettingsDateFormatViewModelFactory(private val dataManager: DataManager) : ViewModelProvider.Factory {
