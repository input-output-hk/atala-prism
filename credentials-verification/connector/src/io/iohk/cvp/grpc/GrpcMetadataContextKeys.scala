...
/**
  * Usually, we need to define the Metadata and the Context keys together, this
  * class makes it easier to do that.
  */
case class GrpcMetadataContextKeys[T](metadata: Metadata.Key[String], context: Context.Key[T])
