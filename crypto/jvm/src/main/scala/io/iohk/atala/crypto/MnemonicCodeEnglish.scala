...
object MnemonicCodeEnglish {
  ...
  /**
    * The english word list for the mnemonic code, from bitcoinj (mnemonic/wordlist/english.txt).
    *
    * We plan to use this library on Android, and this is a way to keep it compatible, another reason
