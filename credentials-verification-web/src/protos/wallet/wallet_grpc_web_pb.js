...
const methodDescriptor_WalletService_GenerateDID = new grpc.web.MethodDescriptor(
  '/io.iohk.cvp.wallet.WalletService/GenerateDID',
  grpc.web.MethodType.UNARY,
  proto.io.iohk.cvp.wallet.GenerateDIDRequest,
  proto.io.iohk.cvp.wallet.GenerateDIDResponse,
  ...
  proto.io.iohk.cvp.wallet.GenerateDIDResponse.deserializeBinary
);
...
/**
 * @param {!proto.io.iohk.cvp.wallet.GenerateDIDRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.io.iohk.cvp.wallet.GenerateDIDResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.io.iohk.cvp.wallet.GenerateDIDResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.io.iohk.cvp.wallet.WalletServiceClient.prototype.generateDID =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/io.iohk.cvp.wallet.WalletService/GenerateDID',
      request,
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.io.iohk.cvp.wallet.GenerateDIDResponse>}
 *     A native promise that resolves to the response
 */
proto.io.iohk.cvp.wallet.WalletServicePromiseClient.prototype.generateDID =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/io.iohk.cvp.wallet.WalletService/GenerateDID',
      request,
