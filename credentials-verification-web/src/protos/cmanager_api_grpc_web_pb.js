 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.io.iohk.prism.protos.UpdateGroupRequest,
 *   !proto.io.iohk.prism.protos.UpdateGroupResponse>}
 */
const methodDescriptor_GroupsService_UpdateGroup = new grpc.web.MethodDescriptor(
  '/io.iohk.prism.protos.GroupsService/UpdateGroup',
  grpc.web.MethodType.UNARY,
  proto.io.iohk.prism.protos.UpdateGroupRequest,
  proto.io.iohk.prism.protos.UpdateGroupResponse,
  /**
   * @param {!proto.io.iohk.prism.protos.UpdateGroupRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.io.iohk.prism.protos.UpdateGroupResponse.deserializeBinary
);
...
/**
 * @param {!proto.io.iohk.prism.protos.UpdateGroupRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.io.iohk.prism.protos.UpdateGroupResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.io.iohk.prism.protos.UpdateGroupResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.io.iohk.prism.protos.GroupsServiceClient.prototype.updateGroup =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/io.iohk.prism.protos.GroupsService/UpdateGroup',
      request,
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.io.iohk.prism.protos.UpdateGroupResponse>}
 *     A native promise that resolves to the response
 */
proto.io.iohk.prism.protos.GroupsServicePromiseClient.prototype.updateGroup =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/io.iohk.prism.protos.GroupsService/UpdateGroup',
      request,
