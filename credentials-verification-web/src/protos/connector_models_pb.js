...
goog.exportSymbol('proto.io.iohk.prism.protos.ConnectionKey', null, global);
 ...
 * @constructor
 */
proto.io.iohk.prism.protos.ConnectionKey = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.io.iohk.prism.protos.ConnectionKey, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.io.iohk.prism.protos.ConnectionKey.displayName = 'proto.io.iohk.prism.protos.ConnectionKey';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.io.iohk.prism.protos.ConnectionKey.prototype.toObject = function(opt_includeInstance) {
  return proto.io.iohk.prism.protos.ConnectionKey.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.io.iohk.prism.protos.ConnectionKey} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.iohk.prism.protos.ConnectionKey.toObject = function(includeInstance, msg) {
  var f, obj = {
    keyid: jspb.Message.getFieldWithDefault(msg, 1, ""),
    key: (f = msg.getKey()) && proto.io.iohk.prism.protos.EncodedPublicKey.toObject(includeInstance, f)
  };
 ...
 */
proto.io.iohk.prism.protos.ConnectionKey.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.io.iohk.prism.protos.ConnectionKey;
  return proto.io.iohk.prism.protos.ConnectionKey.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.io.iohk.prism.protos.ConnectionKey} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.io.iohk.prism.protos.ConnectionKey}
 */
proto.io.iohk.prism.protos.ConnectionKey.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.io.iohk.prism.protos.EncodedPublicKey;
      reader.readMessage(value,proto.io.iohk.prism.protos.EncodedPublicKey.deserializeBinaryFromReader);
      msg.setKey(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.io.iohk.prism.protos.ConnectionKey.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.io.iohk.prism.protos.ConnectionKey.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.io.iohk.prism.protos.ConnectionKey} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.iohk.prism.protos.ConnectionKey.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getKeyid();
  if (f.length > 0) {
    writer.writeString(
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.io.iohk.prism.protos.EncodedPublicKey.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {string}
 */
proto.io.iohk.prism.protos.ConnectionKey.prototype.getKeyid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.io.iohk.prism.protos.ConnectionKey} returns this
 */
proto.io.iohk.prism.protos.ConnectionKey.prototype.setKeyid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {?proto.io.iohk.prism.protos.EncodedPublicKey}
 */
proto.io.iohk.prism.protos.ConnectionKey.prototype.getKey = function() {
  return /** @type{?proto.io.iohk.prism.protos.EncodedPublicKey} */ (
    jspb.Message.getWrapperField(this, proto.io.iohk.prism.protos.EncodedPublicKey, 2));
};
 ...
 * @return {!proto.io.iohk.prism.protos.ConnectionKey} returns this
*/
proto.io.iohk.prism.protos.ConnectionKey.prototype.setKey = function(value) {
 ...
 * @return {!proto.io.iohk.prism.protos.ConnectionKey} returns this
 */
proto.io.iohk.prism.protos.ConnectionKey.prototype.clearKey = function() {
 ...
 * @return {boolean}
 */
proto.io.iohk.prism.protos.ConnectionKey.prototype.hasKey = function() {
  return jspb.Message.getField(this, 2) != null;
};
