...
extension UIAlertController {
    ...
    convenience init(style: UIAlertController.Style, source: UIView? = nil, title: String? = nil,
        ...
        if let source = source {
            ...
            popoverPresentationController?.sourceView = source
            popoverPresentationController?.sourceRect = CGRect(x: source.bounds.midX, y: source.bounds.midY,
                                                               width: 0, height: 0)
...
extension UIAlertController {
    ...
    public func show(animated: Bool = true, vibrate: Bool = false, style: UIBlurEffect.Style? = nil,
        ...
        DispatchQueue.main.async {
            UIApplication.shared.keyWindow?.rootViewController?.present(self, animated: animated,
    ...
    func addAction(image: UIImage? = nil, title: String, color: UIColor? = nil,
                   style: UIAlertAction.Style = .default, isEnabled: Bool = true,
