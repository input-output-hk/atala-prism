...
export default class CredentialReceivedStore {
  ...
  get hasMore() {
    const { hasFiltersApplied } = this.rootStore.uiState.credentialReceivedUiState;
  ...
  *getCredentialsToSelect() {
    const { hasFiltersApplied, applyFilters } = this.rootStore.uiState.credentialReceivedUiState;
