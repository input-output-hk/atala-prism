...
import TemplatesActionButtons from '../../components/connections/Atoms/ActionButtons/TemplatesActionButtons';
...
export const getTemplatesColumns = templateCategories => {
  ...
  const actionColumn = {
    ...
    align: 'right',
    render: template => {
      const actionButtons = <TemplatesActionButtons template={template} />;
