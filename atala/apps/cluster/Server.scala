...
case class Server[S, Tx: Codec: Loggable, Q: Loggable, QR: Loggable] private (
  ...
  def feedMessage(m: NetworkMessage[Tx]): Unit =
    networkInterface.feed(m)
