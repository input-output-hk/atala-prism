...
package object utils {
  ...
  private[utils] def secureRandomByteString(secureRandom: SecureRandom, length: Int): ByteString =
    ByteString(secureRandomByteArray(secureRandom, length))

  private[utils] def secureRandomByteArray(secureRandom: SecureRandom, length: Int): Array[Byte] = {
