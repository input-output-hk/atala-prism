...
class MGF1BytesGeneratorExtSpec extends FlatSpec {
  ...
  private val seed1 = fromHexString("d6e168c5f256a2dcff7ef12facd390f393c7a88d")
  private val mask1 = fromHexString(
  ...
  private val seed2 = fromHexString(
  ...
  private val mask2 = fromHexString(
  ...
  private val seed3 = fromHexString(
    "032e45326fa859a72ec235acff929b15d1372e30b207255f0611b8f785d764374152e0ac009e509e7ba30cd2f1778e113b64e135cf4e2292c75efe5288edfda4")
  private val mask3 = fromHexString(
  ...
  private def generatorAssertion(seed: ByteString, result: ByteString, digest: Digest): Assertion =
    new MGF1BytesGeneratorExt(digest).generateBytes(result.length, seed.toArray) shouldBe result
