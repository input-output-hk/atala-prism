...
class CryptoSpec extends FlatSpec {
  ...
  "kec256" should "get the correct result for a ByteString" in {
    kec256(ByteString("a")) shouldBe fromHexString("3ac225168df54212a25c1c01fd35bebfea408fdac2e31ddd6f80a4bbf9a5f1cb")
  }

  it should "get the correct result for an array" in {
    kec256(Array('a'.toByte)) shouldBe fromHexString("3ac225168df54212a25c1c01fd35bebfea408fdac2e31ddd6f80a4bbf9a5f1cb")
  }

  it should "get the correct result for an array with offset/length combo" in {
    kec256(Array('a'.toByte), 0, 1) shouldBe fromHexString(
