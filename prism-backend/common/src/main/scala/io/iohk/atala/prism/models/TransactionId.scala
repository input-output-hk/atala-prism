...
object TransactionId extends HashValueFrom[TransactionId] {
  ...
  implicit val transactionIdLoggable: DictLoggable[TransactionId] = new DictLoggable[TransactionId] {
    override def fields[I, V, R, S](a: TransactionId, i: I)(implicit r: LogRenderer[I, V, R, S]): R =
      r.addString("TransactionId", a.toString, i)

    override def logShow(a: TransactionId): String = s"TransactionId{${a.toString}"
  }
