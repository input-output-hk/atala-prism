...
usage() {
  print "Usage: jaeger.sh [[-a] [-d] [-p] [-s]] <vpc name>
  Setup Jaeger as tracing collector using zipkin config and ui for viewing the traces.
...
state_key="infra/stage/jaeger/$name/terraform.tfstate"
