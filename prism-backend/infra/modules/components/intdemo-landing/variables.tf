variable "parent_name" {
  description = "A short abbreviation of resource that the landing page instance is created for, e.g. environment name"
}
...
variable "subnets" {
  description = "Subnet to deploy intdemo landing page to - using AWSVPC networking"
}
