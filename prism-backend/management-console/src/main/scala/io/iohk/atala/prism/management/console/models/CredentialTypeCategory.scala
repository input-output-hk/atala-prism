...
object CredentialTypeCategoryId extends UUIDValue.Builder[CredentialTypeId]

@derive(loggable)
sealed abstract class CredentialTypeCategoryState(value: String) extends EnumEntry {
  override def entryName: String = value
}
object CredentialTypeCategoryState extends Enum[CredentialTypeCategoryState] with DoobieEnum[CredentialTypeCategoryState] {
