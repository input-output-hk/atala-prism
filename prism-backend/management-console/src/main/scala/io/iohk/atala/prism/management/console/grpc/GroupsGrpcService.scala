...
class GroupsGrpcService(
  ...
  override def createGroup(
    ...
    auth[CreateInstitutionGroup]("createGroup", request) {
      (institutionId, traceId, request) =>
        groupsService
  ...
  override def getGroups(
    ...
    auth[InstitutionGroup.PaginatedQuery]("getGroups", request) {
      (institutionId, traceId, query) =>
        for {
          result <-
            groupsService
  ...
  override def updateGroup(
    ...
    auth[UpdateInstitutionGroup]("updateGroup", request) {
      (institutionId, traceId, updateInstitutionGroup) =>
        groupsService
          .updateGroup(
            institutionId,
  ...
  override def copyGroup(
    ...
    auth[CopyInstitutionGroup]("copyGroup", request) {
      (institutionId, traceId, copyInstitutionGroup) =>
        groupsService
  ...
  override def deleteGroup(
    ...
    auth[DeleteInstitutionGroup]("deleteGroup", request) {
      (institutionId, traceId, deleteInstitutionGroup) =>
        groupsService
