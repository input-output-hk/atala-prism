...
Somehow orthoghonally to these, BIP39 defines how to encode random binary seeds
...
root node and its child nodes are computed as defined in BIP44. \tabref{tab:bips}
...
% implementations, BIP43 and BIP44 specify how to organize HD wallets so
...
\paragraph{Path notation.} As can be seen in \figref{fig:bip44-tree}, the
...
paragraph of \secref{ssec:mainhdconcepts}.
