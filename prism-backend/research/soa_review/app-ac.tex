\section{Log on Review of Anonymous Credentials Systems}
\label{app:ac}
...
\item In a nutshell, Indy covers layer 1 of the ToIP stack%
  ...
  manages DIDs \doubt{Does Indy also take care of writing credential schemas,
    etc. into the blockchain?}, and Aries uses the DIDs from Indy to establish
