...
% DIDs
\def\IdealFPKIDID{\ensuremath{\IdealF_{PKI{\mhyphen}DID}}\xspace}
...
% Atala
\def\RealPKIDIDAtala{\ensuremath{\Pi_{PKI{\mhyphen}DID}^{Atala}}\xspace}
\def\MasterKey{\texttt{M}}
\def\AuthKey{\texttt{A}}
\def\CommKey{\texttt{C}}
\def\IssueKey{\texttt{I}}
