...
\begin{proof}[\thmref{thm:iss-anonymity-uas}; Issuance anonymity of \CUASGen]
  ...
  the form $\pi^*_0 =\NIZKProve^{\NIZKRel_{\Issue}}(\crs_{\Issue},(\UK[\cuid_0],
  ...
  $\pi^s_0 =\NIZKSim^{\NIZKRel_{\Issue}}(\crs_{\Issue},\tau,(\CCom,\attrs,
  ...
  shape $\pi^s_1 =\NIZKSim^{\NIZKRel_{\Issue}}(\crs_{\Issue},\tau,(\CCom,\attrs,
  \PUBIK[\cscid_1]))$. Note first that $\PUBIK[\cscid_1] = \PUBIK[\cscid_0]$,
  by definition of the \OBTCHAL oracle. Hence, the produced proofs are exactly
