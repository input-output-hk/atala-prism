...
\begin{figure}[htp!]
  \procedure{$\ExpGSACTrace(1^\secpar)$}{%
    ...
    \pcind \pccomment{\Open succeeds, but the proof is rejected by \Judge} \\
    \pcind \Open(\gpk,\osk,\sig,\DAttrs,\msg) =
    (\upk,\oproof) \land \Judge(\gpk,\upk,\oproof,\sig,\DAttrs,\msg) = 0 \\
    ) \\
    \pcreturn 0
  }
