...
\UAS schemes relate with other similar systems. \todo{The relationships seem
...
\todo{In \cite{khk+19}, the authors prove that GS-MDO implies identity-based
...
$\NIZKRel^{\Sign}$ defined in \secref{ssec:generic-construction-uas} reveals the
...
\commentwho{Jesus}{How to cite the Crypto22 paper?}
...
\todo{It would seem that the simulation-based anonymity definition is more
