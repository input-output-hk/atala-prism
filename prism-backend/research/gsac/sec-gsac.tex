...
\todo{I think we should extend ``vanilla'' \GSAC to return the full \Attrs
  in \Open, but without needing \trans as a parameter to \Open (for compatibility
  with \UAS). This can be done by encrypting all attributes, including their
  ciphertext in the signature, and proving they are part of the credential. This
  would render the scheme too costly, but helps in arguing in favour of \UAS.
  Still, leaving that for after having updated the \UAS section, to see how
