...
model given in \cite{bkm06}, if the underlying \CUASGenHideIss
construction is secure.

\begin{theorem}[Anonymity of \CUASRing]
  If the base \CUASGenHideIss construction is anonymous according to
...
\begin{proof}
  ...
  $KeyGen$ simply uses algorithms of \CUASGenHideIss, \advB can do this
