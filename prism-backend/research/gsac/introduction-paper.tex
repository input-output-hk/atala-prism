...
\todo{Mention Camenisch, Krenn and Lehmann's work.}
...
authentication protocols with protection against replay attacks\footnote{This is
  ...
  be signed.}. We further show how to build ring signatures (RS) in the model
given by \cite{bkm06}, from an alternative construction that improves issuer
privacy.
%
