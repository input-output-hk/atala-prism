...
\begin{figure}[ht!]
  ...
  \scalebox{0.95}{
    \begin{minipage}[t]{\textwidth}
      ...
      \begin{align}
        ...
        & \fissue^{\sring}(\usk,\scred,\attrs) \coloneqq \pcif \attrs
          \subseteq \sring \cup \lbrace \CCommit(\usk;0) \rbrace: \pcreturn 1; \pcelse
          \pcreturn 0 \nonumber \\
        & \fissue^{n,\dattrs}(\usk,\cred,\attrs) \coloneqq
          \pcif \attrs_1(\cred) = n+1 \land \dattrs \subseteq \attrs: \pcreturn 1;
          \pcelse \pcreturn 0 \nonumber
      \end{align}
      
      \textbf{Signature evaluation functions:}
      \begin{align}
        & \feval^0(\usk,\scred,\msg) \coloneqq \pcreturn (0,\ast) \nonumber \\
        & \feval^{\dattrs}(\usk,\cred,\msg) \coloneqq \pcreturn
          (\dattrs(\cred),\ast) \nonumber \\
        & \feval^{\attrs}(\usk,\cred,\msg) \coloneqq \pcif \CCommit(\usk;0) \in
          \attrs: \pcreturn (\attrs(\cred),\ast);
          \pcelse \pcreturn (\bot,\bot) \nonumber \\
        & \feval^{n,\dattrs}(\usk,\cred,\msg) \coloneqq
          \pcreturn \pcreturn((\attrs_1(\cred),\dattrs(\cred)),\ast) \nonumber
      \end{align}
    \end{minipage}
  }
  \vspace*{1em}
  ...
  \scalebox{0.95}{
    \begin{minipage}[t]{0.5\textwidth}
      ...
      \begin{align}
        & \finsp^0(\yeval,\usk,\cred,\msg) \coloneqq 0 \nonumber \\        
