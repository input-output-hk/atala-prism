...
\begin{definition}{(\UAS-acceptable \fissue functions)}
  ...
  \UAS-acceptable if, conditioned on it returning a non-zero value, the
  value it produces is indistinguishable from random.
  % %
...
reveal anything about the signer. \todo{Since the concept is quite intuitive, we
  defer the formal definition to \appref{app:XXX}}. We give in
\secref{ssec:generic-construction-uas}
...
\begin{theorem}[Issuance anonymity of \CUASGen]
  ...
  \defref{def:issue-anonymity-uas}.
\end{theorem}
