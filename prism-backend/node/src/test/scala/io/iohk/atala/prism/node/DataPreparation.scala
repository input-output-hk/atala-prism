...
object DataPreparation {
  ...
  def findByDidSuffix(didSuffix: String)(implicit xa: Transactor[IO]): DIDDataState = {
    val query = for {
  ...
  def findKey(didSuffix: String, keyId: String)(implicit xa: Transactor[IO]): Option[DIDPublicKeyState] = {
    PublicKeysDAO
