...
module "mirror_container_definition" {
  ...
  environment = [
    ...
    { name = "ATALA_MIRROR_DB_SYNC_HOST", value = var.cardano_db_sync_psql_host },
    { name = "ATALA_MIRROR_DB_SYNC_USERNAME", value = var.cardano_db_sync_psql_username },
    { name = "ATALA_MIRROR_DB_SYNC_PASSWORD", value = var.cardano_db_sync_psql_password },
    { name = "ATALA_MIRROR_DB_SYNC_DATABASE", value = var.cardano_db_sync_psql_database },
