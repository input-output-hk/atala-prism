...
import io.iohk.cef.data.query.DataItemQuery.{NoPredicateDataItemQuery, Predicate}
import io.iohk.cef.data.query.Value._
import io.iohk.cef.data.query.{DataItemQuery, Field, Value => ValueRef}
import io.iohk.cef.data.{DataItem, DataItemServiceResponse, Owner, Witness}
import play.api.libs.json._

trait DataItemCodecs { this: CommonCodecs =>
  ...
  implicit val DataItemServiceResponseWrites: Writes[DataItemServiceResponse] = {
