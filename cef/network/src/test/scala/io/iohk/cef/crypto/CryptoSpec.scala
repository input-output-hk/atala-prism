...
class CryptoSpec extends FlatSpec {
  ...
  it should "get the correct result for an array with offset/length combo" in {
    kec256(Array('a'.toByte), 0, 1) shouldBe Hex.decode("3ac225168df54212a25c1c01fd35bebfea408fdac2e31ddd6f80a4bbf9a5f1cb")
  }
  ...
  it should "get the correct result for multiple arrays" in {
    kec256(Array('a'.toByte), Array('b'.toByte)) shouldBe Hex.decode("67fad3bfa1e0321bd021ca805ce14876e50acac8ca8532eda8cbf924da565160")
  }

  "kec512" should "get the correct result for an array" in {
    kec512(Array('a'.toByte)) shouldBe Hex.decode("9c46dbec5d03f74352cc4a4da354b4e9796887eeb66ac292617692e765dbe400352559b16229f97b27614b51dbfbbb14613f2c10350435a8feaf53f73ba01c7c")
  }
