...
import io.iohk.cef.ledger.identity.{IdentityBlockHeader, IdentityLedgerState, IdentityLedgerStateImpl, IdentityTransaction}
...
class LedgerStateStorageImpl  extends LedgerStateStorage[Future, IdentityLedgerState, String, IdentityBlockHeader, IdentityTransaction] {
  ...
  override def update[B <: Block[IdentityLedgerState, String, IdentityBlockHeader, IdentityTransaction]](previousHash: ByteString, newState: IdentityLedgerState): Future[Unit] = {
    begin(db => {
      update(db)(previousHash, newState)
    })
  }

  def update[B <: Block[IdentityLedgerState, String, IdentityBlockHeader, IdentityTransaction]](db: DB)(previousHash: ByteString, newState: IdentityLedgerState): Future[Unit] = {
    begin(db => {
